...
class Crud extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $iconPath = Env::get('root_path') . str_replace('/', DIRECTORY_SEPARATOR, '/webpack/node_modules/font-awesome/less/variables.less');
        ...
        $controllerBaseName = strtolower(implode(DIRECTORY_SEPARATOR, $controllerArr));

        //视图文件
        $viewDir = $adminPath . 'view' . DIRECTORY_SEPARATOR . $controllerBaseName . DIRECTORY_SEPARATOR;

        //最终将生成的文件路径
        $javascriptFile = Env::get('root_path') . 'webpack' . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'backend' . DIRECTORY_SEPARATOR . 'js' . DIRECTORY_SEPARATOR . $controllerBaseName . '.js';
