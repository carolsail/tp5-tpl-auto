  ...
  bindevent() {
      ...
      $(document).on('click', ".btn-search-icon", function () {
          if (iconlist.length == 0) {
              $.get(Config.site.rooturl + "/webpack/node_modules/font-awesome/less/variables.less", function (ret) {
                  var exp = /fa-var-(.*):/ig;
                  var result;
...
export function index(){
  ...
  Table.api.init({
      extend: {
          "index_url": fixurl("auth/rule/index"),
          "add_url": fixurl("auth/rule/add"),
          "edit_url": fixurl("auth/rule/edit"),
          "del_url": fixurl("auth/rule/del"),
          "multi_url": fixurl("auth/rule/multi"),
          "table": "auth_rule"
      }
  });
  ...
  table.bootstrapTable({
      ...
      columns: [
          [
              ...
              {field: 'id', title: 'ID'},
              {field: 'title', title: __('Title'), align: 'left', formatter: api.formatter.title},
              {field: 'icon', title: __('Icon'), formatter: api.formatter.icon},
              {field: 'name', title: __('Name'), align: 'left', formatter: api.formatter.name},
              ...
              },
              {
                  ...
                  operate: false,
                  formatter: api.formatter.subnode
              },
              {
                  field: 'operate',
                  title: __('Operate'),
